...
return function(colors, highlight)
    ...
    highlight('Conditional', text_magenta)
    highlight('Constant', text_red)
    highlight('Define', text_magenta)
    ...
    highlight('Keyword', text_magenta)
    ...
    highlight('Exception', text_magenta)
    ...
    highlight('@constant.builtin', { fg = C.fg2 })
    highlight('@constant.macro', text_magenta)
    ...
    highlight('@include', text_magenta)
    ...
    highlight('@keyword.return', text_magenta)
    ...
    highlight('@text.literal', { fg = C.green })
    ...
    highlight('@type.builtin', { fg = C.blue2 })
    ...
    highlight('HarpoonWindow', { bg = C.bg2, fg = C.fg2 })
    highlight('HarpoonActive', { bg = C.bg2, fg = C.fg2 })
    ...
    highlight('NeoTreeNormal', { bg = C.bg2, fg = C.bg2 })
    highlight('NeoTreeNormalNC', { bg = C.bg2, fg = C.bg2 })
    ...
    highlight('NotifyBackground', { fg = C.fg2, bg = C.bg1 })
    ...
    highlight('@lsp.typemod.type.defaultLibrary', { fg = C.blue2, italic = false })
    highlight('@lsp.typemod.type.documentation', text_yellow)
    highlight('@lsp.type.enum', text_yellow)
    highlight('@lsp.typemod.enum.defaultLibrary', { fg = C.blue2, italic = false })
    highlight('@lsp.type.interface', text_yellow)
    highlight('@lsp.typemod.interface.defaultLibrary', { fg = C.blue2, italic = false })
    ...
    highlight('@lsp.typemod.struct.defaultLibrary', { fg = C.blue2, italic = false })
    ...
    highlight(
        ...
        { fg = C.blue2, bold = true, italic = false }
    )
